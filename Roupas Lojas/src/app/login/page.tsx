  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-8 md:py-14">
      ...
      <button
        type="button"
        onClick={() => {
          setEmail("demo@jpstore.com.br");
          setPassword("demo1234");
        }}
        className="mt-4 text-center text-xs text-mist underline underline-offset-4 hover:text-ink"
      >
        Preencher conta demo (demo@jpstore.com.br)
      </button>
